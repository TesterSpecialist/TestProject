...
<xsl:param    name="titleReport" select="'Request Detail of Jmeter'"/>
<xsl:param    name="dateReport" select="'date not defined'"/>
        ...
        <head>
            ...
            <style type="text/css"><![CDATA[
                ...
                * { margin: 0; padding: 0 }
                ...
                #left-panel { position: absolute; left: 0; top: 130px; bottom: 0; width: 300px; overflow: auto; background: #dee4ea }
                ...
                #right-panel { position: absolute; right: 0; top: 130px; bottom: 0; left: 301px; overflow: auto; background: white }
                ...
                #right-panel pre.data { white-space: normal }
	...
	<table width="100%">
		<tr>
			...
			<td align="left" font-size="13px">Date report: <xsl:value-of select="$dateReport" /></td>
			<!--  <td align="center">Host: <xsl:value-of select="substring($newURL,1,20)" /></td>-->
			<td align="right">Request: <a href="../../../Jmeter/apache-jmeter-2.13/ReportHtml/TestReport.html">Detail Result</a></td>
		</tr>
	</table>
	<hr size="1" />
</xsl:template>
